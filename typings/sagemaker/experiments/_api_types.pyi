...
class TrialComponentMetricSummary(_base_types.ApiObject):
    ...
    avg = ...
    std_dev = ...
    def __init__(self, metric_name=..., source_arn=..., **kwargs) -> None:
        ...
...
class TrialComponentArtifact(_base_types.ApiObject):
    ...
    value = ...
    media_type = ...
    def __init__(self, value=..., media_type=..., **kwargs) -> None:
        ...
...
class TrialComponentStatus(_base_types.ApiObject):
    ...
    primary_status = ...
    message = ...
    def __init__(self, primary_status=..., message=..., **kwargs) -> None:
        ...
...
class TrialComponentSource(_base_types.ApiObject):
    ...
    """
    source_arn = ...
    def __init__(self, source_arn=..., **kwargs) -> None:
        ...

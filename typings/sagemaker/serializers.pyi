...
This type stub file was generated by pyright.
"""
def retrieve_options(region: Optional[str] = ..., model_id: Optional[str] = ..., model_version: Optional[str] = ..., tolerate_vulnerable_model: bool = ..., tolerate_deprecated_model: bool = ..., sagemaker_session: Session = ...) -> List[BaseSerializer]:
...
def retrieve_default(region: Optional[str] = ..., model_id: Optional[str] = ..., model_version: Optional[str] = ..., tolerate_vulnerable_model: bool = ..., tolerate_deprecated_model: bool = ..., sagemaker_session: Session = ...) -> BaseSerializer:
